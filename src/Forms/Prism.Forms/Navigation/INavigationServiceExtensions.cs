    ...
    public static class INavigationServiceExtensions
    {
        ...
        private static void ProcessModalNavigation(Page page, Stack<string> stack)
        {
            ...
            for (int x = previousPageIndex; x >= 0; x--)
            {
                ...
                else if (childPage is FlyoutPage)
                {
                    ProcessModalMasterDetailPagePath((FlyoutPage)childPage, stack);
                }
                else
                {
        ...
        private static void ProcessMainPagePath(Page mainPage, Page previousPage, Stack<string> stack)
        {
            ...
            else if (mainPage is FlyoutPage)
            {
                var detail = ((FlyoutPage)mainPage).Detail;
        ...
        private static void ProcessModalMasterDetailPagePath(FlyoutPage page, Stack<string> stack)
        {
