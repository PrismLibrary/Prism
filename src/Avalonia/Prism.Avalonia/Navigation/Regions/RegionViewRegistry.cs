...
namespace Prism.Navigation.Regions
{
    ...
    public class RegionViewRegistry : IRegionViewRegistry
    {
        ...
        /// <summary>Creates a new instance of the <see cref="RegionViewRegistry"/> class.</summary>
        ...
        /// <summary>Occurs whenever a new view is registered.</summary>
        ...
        /// <summary>Returns the contents registered for a region.</summary>
        ...
        /// <summary>Registers a content type with a region name.</summary>
        ...
        /// <summary>Registers a delegate that can be used to retrieve the content associated with a region name.</summary>
        ...
        /// <summary>Creates an instance of a registered view <see cref="Type"/>.</summary>
