...
namespace Prism.DryIoc
{
    ...
    public static class DryIocExtensions
    {
        ...
        public static void RegisterTypeForNavigation<TPage>(this IContainer container) where TPage : Page, new()
        {
        ...
        public static void RegisterTypeForNavigation<TPage>(this IContainer container, string name) where TPage : Page, new()
        {
            container.Register<Page>(made: Made.Of(() => new TPage()), serviceKey: name);
        ...
        public static void RegisterTypeForNavigation<TPage, TClass>(this IContainer container) where TPage : Page, new()
            where TClass : class
        {
