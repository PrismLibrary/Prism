...
namespace Prism.DryIoc
{
    ...
    public static class DryIocExtensions
    {
        ...
        public static void RegisterTypeForNavigation<TPage>(this IContainer container) where TPage : Xamarin.Forms.Page
        {
        ...
        public static void RegisterTypeForNavigation<TPage>(this IContainer container, string name) where TPage : Xamarin.Forms.Page
        {
            container.Register<TPage>(serviceKey: name);
        ...
        public static void RegisterTypeForNavigation<TPage, TClass>(this IContainer container) where TPage : Xamarin.Forms.Page
            where TClass : class
        {
