...
{
    /// <summary>
    /// Extension methods to register a <see cref="Xamarin.Forms.Page"/> with <see cref="PageNavigationRegistry"/> using <see cref="Container"/>
    /// </summary>
    public static class SimpleInjectorExtensions
    {
        ...
        public static void RegisterTypeForNavigation<TView>(this Container container, string name = null) where TView : Page
        {
        ...
        /// Registers a Page for navigation
        /// </summary>
        /// <param name="container"><see cref="Container"/> used to register type for Navigation.</param>
        ...
        public static void RegisterTypeForNavigation<TView, TViewModel>(this Container container, string name = null) 
            where TView : Page
		...
		public static void RegisterTypeForNavigationOnPlatform<TView, TViewModel>(this Container container, string name = null, Type androidView = null, Type iOSView = null, Type otherView = null, Type windowsView = null, Type winPhoneView = null)
            where TView : Page
            where TViewModel : class
        {
            if (string.IsNullOrWhiteSpace(name))
		...
		public static void RegisterTypeForNavigationOnPlatform<TView, TViewModel>(this Container container, params IPlatform[] platforms)
			where TView : Page
			where TViewModel : class
		{
		...
		/// <param name="platforms"></param>
		public static void RegisterTypeForNavigationOnPlatform<TView, TViewModel>(this Container container, string name, params IPlatform[] platforms)
			where TView : Page
			where TViewModel : class
		{
			if (string.IsNullOrWhiteSpace(name))
		...
		public static void RegisterTypeForNavigationOnIdiom<TView, TViewModel>(this Container container, string name = null, Type desktopView = null, Type tabletView = null, Type phoneView = null)
            where TView : Page
            where TViewModel : class
        {
            if (string.IsNullOrWhiteSpace(name))
        ...
        /// <summary>
        /// Returns an instance of a Page registered with the specified name.
        /// </summary>
        /// <param name="container"><see cref="Container"/> to resolve the instance against.</param>
        /// <param name="name">The unique name of the Page.</param>
        /// <returns>New instance of the page registeredw ith the specified name.</returns>
        internal static object GetInstance(this Container container, string name)
        {
            return container.GetInstance(PageNavigationRegistry.GetPageType(name));
        }

        private static void RegisterTypeForNavigationWithViewModel<TViewModel>(this Container container, Type viewType, string name = null)
            where TViewModel : class
        {
            if (string.IsNullOrWhiteSpace(name))
                name = viewType.Name;
