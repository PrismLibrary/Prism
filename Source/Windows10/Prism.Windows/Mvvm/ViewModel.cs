...
namespace Prism.Windows.Mvvm
{
    ...
    public class ViewModel : BindableBase, INavigationAware
    {
        ...
        public virtual void OnNavigatedTo(FrameNavigatedToEventArgs e, Dictionary<string, object> viewModelState)
        {
        ...
        public virtual void OnNavigatingFrom(FrameNavigatingFromEventArgs e, Dictionary<string, object> viewModelState, bool suspending)
        {
            if (viewModelState != null)
            {
