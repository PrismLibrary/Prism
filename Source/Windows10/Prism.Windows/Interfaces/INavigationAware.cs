...
namespace Prism.Windows.Interfaces
{
    ...
    public interface INavigationAware
    {
        ...
        void OnNavigatedTo(FrameNavigatedToEventArgs e, Dictionary<string, object> viewModelState);
        ...
        void OnNavigatingFrom(FrameNavigatingFromEventArgs e, Dictionary<string, object> viewModelState, bool suspending);
    }
}
