...
namespace Prism.Windows.Tests.Mocks
{
    public class MockPageViewModel : ViewModel
    {
        ...
        public override void OnNavigatedTo(FrameNavigatedToEventArgs e, Dictionary<string, object> viewState)
        {
            this.OnNavigatedToCommand(e.Parameter, e.NavigationMode, viewState);
        }

        public override void OnNavigatingFrom(FrameNavigatingFromEventArgs e, Dictionary<string, object> viewState, bool suspending)
        {
